...
fun IrBuilderWithScope.irCallDiagram(
    ...
    fun IrBuilderWithScope.irExpression(it: IrTemporaryVariable): IrConstructorCall {
        val value = it.toValueDisplay2(callInfo)
...
private data class ValueDisplay2(
    val value: IrVariable,
    val indent: Int,
    val row: Int,
)

private fun IrTemporaryVariable.toValueDisplay2(
    ...
    return ValueDisplay2(temporary, indent, row)
}
