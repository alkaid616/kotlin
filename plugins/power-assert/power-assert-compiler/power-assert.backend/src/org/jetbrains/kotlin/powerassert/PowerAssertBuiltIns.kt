...
class PowerAssertBuiltIns(
    ...
    val expressionConstructor = expressionClass.primaryConstructor()
    ...
    val valueParameterClass = referenceClass(classId(callExplanationClassId, "ValueParameter"))
    val valueParameterType = valueParameterClass.defaultTypeWithoutArguments
    val valueParameterConstructor = valueParameterClass.primaryConstructor()
