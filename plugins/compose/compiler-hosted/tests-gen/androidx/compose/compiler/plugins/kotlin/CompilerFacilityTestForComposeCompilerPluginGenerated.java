...
public class CompilerFacilityTestForComposeCompilerPluginGenerated extends AbstractCompilerFacilityTestForComposeCompilerPlugin {
  ...
  @Test
  @TestMetadata("sourceLibModulePrebuiltInlineDependency.kt")
  public void testSourceLibModulePrebuiltInlineDependency() {
    runTest("plugins/compose/compiler-hosted/testData/codegen/sourceLibModulePrebuiltInlineDependency.kt");
  }

  @Test
  @TestMetadata("sourceLibModulePrebuiltInlineDependency2.kt")
  public void testSourceLibModulePrebuiltInlineDependency2() {
    runTest("plugins/compose/compiler-hosted/testData/codegen/sourceLibModulePrebuiltInlineDependency2.kt");
  }

  @Test
  @TestMetadata("sourceLibModulePrebuiltInlineDependency3.kt")
  public void testSourceLibModulePrebuiltInlineDependency3() {
    runTest("plugins/compose/compiler-hosted/testData/codegen/sourceLibModulePrebuiltInlineDependency3.kt");
  }
