...
class IrJavaIncompatibilityRulesOverridabilityCondition : IrExternalOverridabilityCondition {
    ...
    private fun doesJavaOverrideHaveIncompatibleValueParameterKinds(
        ...
        require(originalSubMember.allParameters.size == originalSuperMember.allParameters.size) {
        ...
        return originalSubMember.allParameters
            .filterNot { it.kind == IrParameterKind.DispatchReceiver }
            .any { param ->
                isJvmParameterTypePrimitive(originalSuperMember, param.index) != isJvmParameterTypePrimitive(originalSubMember, param.index)
            }
    }
    ...
    private fun isJvmParameterTypePrimitive(function: IrSimpleFunction, index: Int): Boolean {
        ...
        val type = function.allParameters[index].type
